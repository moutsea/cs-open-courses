/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 2f4d7633222b19e40c393f20481a1239)
...
interface __BaseEnv_CloudflareEnv {
	...
	NEXTJS_ENV: string;
	GITHUB_TOKEN: string;
	GITHUB_PROJECTS_CRON_SECRET: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "GITHUB_TOKEN" | "GITHUB_PROJECTS_CRON_SECRET">> {}
}
