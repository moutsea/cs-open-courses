...
The projects are very innovative and interesting. The following description uses the Fall 2020 public edition as an example; current project topics and ordering may differ. Project1 is a warmup assignment in C that used the famous *Game of Life*. Project2 requires you to write a fully-connected neural network in RISC-V assembly to classify handwritten digits in MNIST dataset, which is a great exercise in writing assembly code. In Project3, you use Logisim to build a two-stage pipelined CPU and run RISC-V assembly on it. Project4 implements a toy version of NumPy and accelerates matrix operations with OpenMP, SIMD, and related techniques.

In a word, this is the best computer architecture course I have ever taken.

## Course Resources

- Course Website: [Summer 2026 current offering](https://cs61c.org/)
- Course Website (Backup): [Fall 2024 Wayback Machine](https://web.archive.org/web/20241219154359/https://cs61c.org/fa24/), [Fall 2020 Wayback Machine](https://web.archive.org/web/20220120134001/https://inst.eecs.berkeley.edu/~cs61c/fa20/), [Fall 2020 backup](https://www.learncs.site/docs/curriculum-resource/cs61c/syllabus)
...
- Assignments: [Summer 2026 calendar, labs, and projects](https://cs61c.org/su26/), [Fall 2020 backup](https://github.com/InsideEmpire/CS61C-Assignment#)
