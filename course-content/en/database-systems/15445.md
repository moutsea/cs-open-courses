...
- Course Website: [Spring 2026 current offering](https://15445.courses.cs.cmu.edu/), [Spring 2023 archive](https://15445.courses.cs.cmu.edu/spring2023/schedule.html), [Fall 2022 archive](https://15445.courses.cs.cmu.edu/fall2022/schedule.html)
- Recordings: see the [Spring 2026 schedule](https://15445.courses.cs.cmu.edu/spring2026/schedule.html); the [Fall 2022 YouTube lectures](https://www.youtube.com/playlist?list=PLSE8ODhjZXjaKScG3l0nuOiDTTqpfnWFf) remain publicly available.
- Textbook: Database System Concepts
- Assignments: see the [Spring 2026 assignments](https://15445.courses.cs.cmu.edu/spring2026/assignments.html); project count and content change between semesters.
...
Later offerings continued to adjust project content and ordering. Consult the current Assignments page to determine whether a Recovery project is included instead of inferring it from historical project numbers.
...
[CMU 15-721 Spring 2020](https://15721.courses.cs.cmu.edu/spring2020/) is a graduate-level course on advanced database-system topics. It focuses on in-memory databases and pairs each lecture with research-paper reading, making it a useful next step for learners who want to go deeper.
