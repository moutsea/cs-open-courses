...
Peking University first introduced *Pintos* as a project in its Spring 2022 operating-systems lab course. At the time, I worked with [another TA](https://github.com/AlfredThiel) to write comprehensive [lab documentation](https://pkuflyingpig.gitbook.io/pintos) and provide a Docker-based cross-platform environment. These materials remain useful for independent learners.
