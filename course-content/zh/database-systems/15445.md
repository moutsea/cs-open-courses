...
- 课程网站：[Spring 2026 当前学期](https://15445.courses.cs.cmu.edu/)、[Spring 2023 归档](https://15445.courses.cs.cmu.edu/spring2023/schedule.html)、[Fall 2022 归档](https://15445.courses.cs.cmu.edu/fall2022/schedule.html)
- 课程视频：[Spring 2026 课程日历](https://15445.courses.cs.cmu.edu/spring2026/schedule.html)，Fall 2022 的 [YouTube Lectures](https://www.youtube.com/playlist?list=PLSE8ODhjZXjaKScG3l0nuOiDTTqpfnWFf) 仍可公开观看。
- 课程教材：Database System Concepts
- 课程作业：详见 [Spring 2026 Assignments](https://15445.courses.cs.cmu.edu/spring2026/assignments.html)，项目数量和内容会随学期调整。
...
后续学期持续调整 Project 的内容与顺序，是否包含 Recovery 相关项目应以当前学期的 Assignments 页面为准，不建议再从旧版项目编号推断。
...
[CMU15-721 Spring 2020](https://15721.courses.cs.cmu.edu/spring2020/) 主要讲主存数据库相关内容，每节课都有对应的论文阅读，推荐给希望继续深入数据库系统的学习者。
