...
- 由于新版实验题目及实验手册未在寒武纪论坛同步更新，下面的社区仓库存储了新版实验题目、实验手册以及个人实验答案。
- 该仓库已适配国科大 2025 年春季学期，并在 2026 年继续更新实验代码；具体完成度与变更请以仓库 README 和更新日志为准。
- @Yuichi 维护的新版实验题目、手册及答案：[Yuichi1001/2024-AICS-EXP](https://github.com/Yuichi1001/2024-AICS-EXP)
