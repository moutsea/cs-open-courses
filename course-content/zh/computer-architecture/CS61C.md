...
这门课的 Project 也非常新颖有趣。以下内容以 Fall 2020 公开版本为例，最新学期的题目和顺序可能不同。Project1 会让你用 C 语言写一个小程序，Fall 2020 是著名的游戏 *Game of Life*。Project2 会让你用 RISC-V 汇编编写一个神经网络，用来
...
- 课程网站：[Summer 2026 当前学期](https://cs61c.org/)
- 课程网站（页面备份）：[Fall 2024 Wayback Machine](https://web.archive.org/web/20241219154359/https://cs61c.org/fa24/)、[Fall 2020 Wayback Machine](https://web.archive.org/web/20220120134001/https://inst.eecs.berkeley.edu/~cs61c/fa20/)、[Fall 2020 备份](https://www.learncs.site/docs/curriculum-resource/cs61c/syllabus)
...
- 课程作业：[Summer 2026 课程日历、Labs 与 Projects](https://cs61c.org/su26/)、[Fall 2020 备份](https://github.com/InsideEmpire/CS61C-Assignment#)
