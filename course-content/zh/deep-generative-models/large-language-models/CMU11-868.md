...
该课程要求你对深度学习有一定的预备知识，不适合纯小白入手，可见 [当前课程 FAQ](https://llmsystem.github.io/llmsystem2026fall/docs/FAQ/) 的先修要求。
实验总体来说是有难度的，主要内容如下：
...
- 课程网站：[Fall 2026 最新版本](https://llmsystem.github.io/llmsystem2026fall/)、[Spring 2026 归档](https://llmsystem.github.io/llmsystem2026spring/)、[历年课程入口](https://llmsystem.github.io/)
- 课程大纲：<https://llmsystem.github.io/llmsystem2026fall/docs/Syllabus/>
- 课程作业：<https://llmsystem.github.io/llmsystemhomework/>
