...
const tutorialSections: TutorialSection[] = [
  {
    ...
    topics: [
      ...
      { name: "IDE & Development Environment", level: "Beginner", duration: "2 hours", description: "Set up VS Code, debugging tools, and development workflow" },
        ...
        sections: [
          {
            ...
            topics: [
              ...
              { name: "IDE与开发环境", level: "Beginner", duration: "2 hours", description: "设置VS Code、调试工具和开发工作流" },
                  ...
                  <div className="flex-grow">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {section.topics.map((topic, topicIndex) => (
                        <div key={topicIndex} className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
